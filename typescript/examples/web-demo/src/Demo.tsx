...
function toProtobufTime({ sec, nsec }: Time): { seconds: number | bigint; nanos: number } {
...
function deviceOrientationToPose(event: DeviceOrientationEvent): ProtobufObject<PoseInFrame> {
